...
plt.plot(x_plt, y_pull_light, label="Pull: towards the goal")

plt.xlabel("Distance")
plt.ylabel("Magnitude")
plt.ylim(ymin=0, ymax=1)
plt.xlim(xmin=0, xmax=X_LIM)
plt.title('Push-pull forces for the leader agent')

plt.legend(bbox_to_anchor=(1.05, 0), loc="lower right")

plt.grid()

plt.savefig('png/forces_leader.png', transparent=False, dpi=300)
plt.show()
